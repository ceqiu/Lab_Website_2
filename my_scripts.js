...
function loadStatsPage(){
	...
	for(row_counter = 2; row_counter < table.rows.length; row_counter++){
		var home_value = Number(table.rows[row_counter].cells[2].innerHTML);
		var opp_value = Number(table.rows[row_counter].cells[3].innerHTML);
...
function switchPlayers(playerNum){
	...
	var a = players[playerNum].pass_yards / players[playerNum].games_played;
	document.getElementById('avg_p_yards').innerHTML = a.toFixed();
	document.getElementById('r_yards').innerHTML = players[playerNum].rushing_yards;
	var b = players[playerNum].rushing_yards / players[playerNum].games_played;
	document.getElementById('avg_r_yards').innerHTML = b.toFixed();
	document.getElementById('rec_yards').innerHTML = players[playerNum].receiving_yards;
	var c = players[playerNum].receiving_yards / players[playerNum].games_played;
	document.getElementById('avg_rec_yards').innerHTML = c.toFixed();
}
